...
fdr = 1-myRes$GeneProbDE
fdr_inv = 1-myRes$Pswitching
...
ggp_1 = ggplot(RES_ggplot, aes(threshold, FPs, colour = method)) +
...
Gene_RES_ggplot_points = RES_ggplot_points
save(Gene_RES_ggplot_points, ggp_1, file = "Gene_RES_ggplot_points.RData")
