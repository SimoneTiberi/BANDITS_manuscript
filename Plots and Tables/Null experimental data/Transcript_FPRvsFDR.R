...
ggp_4 = ggplot(RES_ggplot, aes(threshold, FPs, colour = method)) +
...
Tr_FDR_RES_ggplot_points = RES_ggplot_points
save(Tr_FDR_RES_ggplot_points, ggp_4, file = "Tr_FDR_RES_ggplot_points.RData")
