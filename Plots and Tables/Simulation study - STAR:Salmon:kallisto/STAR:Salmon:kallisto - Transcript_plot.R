...
RES$BANDITS_Salmon_maxGene = fdr_maxGene[match]
...
RES$BANDITS_kallisto_maxGene = fdr_maxGene[match]
...
ggp_tr_6vs6 = ggp_tr      # for 3 vs 3 vs 6 simulation;
ggp_tr_6vs6_filt = ggp_tr # for 3 vs 3 vs 6 simulation with transcript pre-filtering;
...
ggarrange(ggp_tr_6vs6, ggp_tr_6vs6_filt,
          labels = c("A", "B"),
          common.legend = TRUE, legend = "right",
          nrow = 2, ncol = 1)
# saved with size: 12 * 18 cm
# name SalmonKallisto_Tr2in1218LegendBottom, alias Figure S24.
