...
# reads were aligned to the filtered transcriptome via bowtie2

# the reference transcriptome:
fasta="Homo_sapiens.GRCh37.71.SELECTED_FILT01_STARMultiMap.cdna.all.fa"

# the reference genome:
gtf="Homo_sapiens.GRCh37.71.sorted_matchFilteredFasta&Filtered_FILT01.gtf"

# input aligned reads folder:
input_dir="6vs6_sim/aligned_reads_filt01_bowtie2"
########################################################################################################################
...
R CMD BATCH \
'--args Homo_sapiens.GRCh37.71.SELECTED_FILT01_STARMultiMap.cdna.all.fa Homo_sapiens.GRCh37.71.sorted_matchFilteredFasta&Filtered_FILT01.gtf out_ex' \
